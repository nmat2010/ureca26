...
def _inlp_project_out(
    ...
    for i in range(max_iter):
        ...
        probe = LogisticRegression(C=0.01, max_iter=1000, solver="lbfgs", random_state=42)
...
def compute_residual_probe_accuracy(
    ...
    for layer in range(L):
        ...
        probe_orig = LogisticRegression(C=0.01, max_iter=1000, solver="lbfgs", random_state=42)
        ...
        probe_res = LogisticRegression(C=0.01, max_iter=1000, solver="lbfgs", random_state=42)
